...
static const int    NSAMPLES_PER_CYCLE = 10; // Number of samples to take in a duty cycle 5
...
//
//        /* Calculated Output */
//        sprintf(msg, "%1i: % 6.4f % 6.4f", ipsd, voltage(double(difference[ipsd].x2-difference[ipsd].x1))/voltage(double(difference[ipsd].x2+difference[ipsd].x1)), 
